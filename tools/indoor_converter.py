...
from floorplan_data_utils import FloorplanData
...
def create_indoor_info_file(data_path,
    ...
    assert pkl_prefix in ['scannet', 'scannet200','floorplan'], \
    ...
    elif pkl_prefix == 'floorplan':
        train_dataset = FloorplanData(root_path=data_path, split='train')
        # val_dataset = FloorplanData(root_path=data_path, split='val')
        test_dataset = FloorplanData(root_path=data_path, split='test')
    else:  # ScanNet200
        # ScanNet has a train-val-test split
        train_dataset = ScanNetData(root_path=data_path, split='train',
